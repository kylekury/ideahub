...
public class HibernateDAOTestUtil {
    ...
    public HibernateDAOTestUtil(final List<Class<?>> entitiesClass) {
        ...
        this.setupCanonicalTimezone();
        this.setupSessionAndTransaction();
    }

    private void setupCanonicalTimezone() {
        // Setting canonical timezone to UTC.
        final TimeZone defaultTimeZone = TimeZone.getTimeZone("UTC");
